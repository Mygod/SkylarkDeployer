        ...
        <form method="post" action="/3/">
            <fieldset>
                ...
                <div class="input-control radio default-style">
                    ...
                    <br />
                    <small>
                        说明：如果您把您的 云雀™ 拆了且希望重装，使用重部署将不会再创建一个新的 云雀™，您需要在名称内填写域名，尤其是当您的域名是 name-x 的形式时。<br />
                        如果你想修改您的 云雀™ 的故乡，请在这里删除您旧的 云雀™ 然后再重新部署一个新的。修改故乡需要一段时间使 DNS 服务器更新缓存，之后您才能连接到您新的 云雀™ 上。您可以运行 <code>ipconfig /flushdns</code> 清除本地缓存来加快这个进程。<br />
